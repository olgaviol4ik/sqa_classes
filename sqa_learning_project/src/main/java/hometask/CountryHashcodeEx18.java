...
public class CountryHashcodeEx18 {
	String countryCode;
	String countryName;
	Long population;
	String currency;
	
	public CountryHashcodeEx18(){}
	
	public CountryHashcodeEx18(String countryCode, String countryName, Long population, String currency){
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CountryHashcodeEx18 other = (CountryHashcodeEx18) obj;
		if (countryCode == null) {
