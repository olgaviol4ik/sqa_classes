...
//Implement the Triangle class similar to circle class, only different there is height and width instead of radius
//and getArea() will have height and width instead of radius. 
//Create a shape caller class with a main method in it.
//Create the object of circle class and triangle class and pass name 
